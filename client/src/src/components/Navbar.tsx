...
export function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-800 fixed w-full top-0 z-40 transition-colors">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:ml-6 md:flex md:items-center md:space-x-2">
            ...
            <button
              ...
              className="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            >
